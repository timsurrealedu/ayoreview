...
export default function LandingPage() {
  return <main lang="id" className={`landing ${archivo.variable}`}>
    ...
    <section className="closing" aria-labelledby="closing-title"><div><ReviewStars label="Lima bintang Ulasan Google" /><h2 id="closing-title">Ubah kepuasan pelanggan menjadi ulasan yang terlihat.</h2><p>Pasang AyoReview di bisnis Anda dan mulai meminta ulasan dengan cara yang lebih mudah.</p></div><Link href="/pesan" className="button button-inverse">Beli Sekarang <ArrowRight aria-hidden="true" /></Link></section>
    <footer><Link href="/" className="wordmark"><span aria-hidden="true">A</span>AyoReview</Link><p>Kartu NFC + QR untuk Ulasan Google.</p><div><Link href="/login">Masuk</Link><Link href="/pesan">Beli Sekarang</Link></div><small>© 2026 AyoReview. Hak cipta dilindungi.</small></footer>
  </main>;
}
